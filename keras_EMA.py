...
class ExponentialMovingAverage(Callback):
    ...
    def on_train_begin(self, logs={}):
        self.sym_trainable_weights = self.model._collected_trainable_weights
    ...
    def _make_mv_model(self, filepath):
        ...
        for w2, w in zip(model2._collected_trainable_weights, self.model._collected_trainable_weights):
