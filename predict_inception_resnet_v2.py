...
test_dir = 'data/test'
num_workers = 4
submit_dir = 'submission/inception_resnet_v2'
submit_filename = 'trainval_fold1_10epochs.csv'
...
folds = ['trainval.fold1.best.hdf5']
predictions = []
for fold in folds:
    ...
    model.load_weights('checkpoint/inception_resnet_v2/{}'.format(fold))
